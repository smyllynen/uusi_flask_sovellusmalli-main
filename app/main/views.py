...
from . import main
from .forms  import EditProfileForm, EditProfileAdminForm, TarjousForm
from .. import db
from ..models import Role, User, Tarjous
...
@main.route('/tarjous', methods=['GET', 'POST'])
def tarjous():
     form = TarjousForm()
     if form.validate_on_submit():
        tarjous = Tarjous()
        form.populate_obj(tarjous)
        db.session.add(tarjous)
        db.session.commit()
        return redirect(url_for('.tarjous'))
     tarjous = Tarjous.query.order_by(Tarjous.id.desc()).first()
     return render_template('tarjous.html', form=form, tarjous=tarjous)
